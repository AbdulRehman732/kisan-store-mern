...
- Name: farmer.spec.js >> Stakeholder Institutional Experience Flow >> Marketplace Dynamics & Assessment
- Location: tests\farmer.spec.js:14:3
...
Call log:
  - waiting for getByRole('button', { name: 'Analyze Index' })
