    ...
    <Layout>
      ...
      <Main>
        <TopHeader>
          ...
          <HeaderActions>
            <StoreBtn to="/">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M10 19l-7-7m0 0l7-7m-7 7h18" strokeLinecap="round" strokeLinejoin="round"/></svg>
              Return to Store
            </StoreBtn>
            <ThemeToggle />
