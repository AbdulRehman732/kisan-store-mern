  ...
  return (
    <PageWrap>
      <Card>
        ...
        <Desc>Enter your institutional email and we'll log a reset link to the operational terminal.</Desc>
        ...
        <form onSubmit={handleSubmit}>
          <FormGroup>
            ...
            <input 
              ...
              placeholder="farmer@kisanstore.pk"
            />
          </FormGroup>
          <Btn type="submit" disabled={loading}>{loading ? "PROCESSING..." : "GET RESET LINK"}</Btn>
        </form>
